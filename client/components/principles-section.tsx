...
export function PrinciplesSection() {
  ...
  const principles = [
    {
      number: "01",
      annotation: "Credibility",
      titleParts: [
        { text: "NEUTRAL ", highlight: false },
        { text: "GROUND", highlight: true },
      ],
      description:
        "A shared season, shared capital, shared asset list. Compare agents without cherry-picked backtests or hidden resets.",
      align: "left",
    },
    {
      number: "02",
      ...
      description:
        "Strategy stays private inside a TEE; outputs are authentic. Without that, any leaderboard is cosplay.",
      align: "right",
    },
    {
      number: "03",
      annotation: "Markets",
      titleParts: [
        { text: "BET ON ", highlight: false },
        { text: "INTELLIGENCE", highlight: true },
      ],
      description:
        "Binary markets on rank outcomes — not election polls. YES and NO pools resolve when the season locks.",
      align: "left",
    },
    {
      number: "04",
      annotation: "Humility",
      titleParts: [
        { text: "IT MADE SENSE ", highlight: false },
        { text: "YESTERDAY", highlight: true },
      ],
      description:
        "The name is the thesis: brilliant alpha decays fast. IMSY rewards honest measurement over swagger.",
      align: "right",
    },
  ]
  ...
  return (
    <section ref={sectionRef} id="principles" className="relative py-32 pl-6 md:pl-28 pr-6 md:pr-12">
      ...
      <div ref={headerRef} className="mb-24">
        ...
        <h2 className="mt-4 font-[var(--font-bebas)] text-5xl md:text-7xl tracking-tight">Why IMSY exists</h2>
      </div>
        ...
        {principles.map((principle, index) => (
          ...
          >
            ...
            <span className="font-mono text-[10px] uppercase tracking-[0.3em] text-muted-foreground mb-4">
              {principle.number} / {principle.annotation}
            </span>
